...
$xajax = new xajax("newportal.server.php");
//$xajax->debugOn();
$xajax->waitCursorOff();
...
$xajax->registerFunction("showAddRemind");    //显示增加提醒的html代码
$xajax->registerFunction("showRemindData");   //显示提醒数据
$xajax->registerFunction("addNewRemind");     //增加提醒
$xajax->registerFunction("showRemindByTime"); //根据时间显示提醒
