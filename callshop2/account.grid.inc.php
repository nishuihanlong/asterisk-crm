...
class Customer extends astercrm
{
	...
	*/
	function &getAllRecords($start, $limit, $order = null, $creby = null){
		...
		$sql = "SELECT account.id as id, username, password, usertype, groupname, account.addtime as addtime FROM account LEFT JOIN accountgroup ON accountgroup.id = account.groupid";
	...
	*/
	...
	function &getRecordsFilteredMore($start, $limit, $filter, $content, $order,$table, $ordering = ""){
		...
		$sql = "SELECT account.id as id, username, password, usertype, groupname, account.addtime as addtime FROM account LEFT JOIN accountgroup ON accountgroup.id = account.groupid WHERE ";
		if ($_SESSION['curuser']['usertype'] == 'admin'){
			$sql .= " 1 ";
		}else{
