<?php
/*******************************************************************************
* peerstatus.common.php
* peerstatus参数信息文件
* peerstatus parameter file
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'peerstatus');

$xajax = new xajax("peerstatus.server.php");
$xajax->waitCursorOff();
