	...
	function generateCopyright($skin){
		...
		$html .='
				...
				<div align="center">
					...
					<tr>
						<td>
							©2009 astercc - <a href="http://www.astercc.org" target="_blank">asterbilling home</a><br>
							version: 0.1 in asterCC 0.13b
						</td>
					</tr>
					</table>
				</dvi>
...
//		$aryMenu['statistic'] = array("link"=>"statistic.php","title"=> $locate_common->Translate("Statistic"));
		...
		if ($_SESSION['curuser']['usertype'] == 'admin'){
			if($config['customers']['enable']){
				...
				$aryCurMenu =array('account','accountgroup','resellergroup','report','customerrate','callshoprate','resellerrate','clid','import','cdr','credithistory','system');
			}
