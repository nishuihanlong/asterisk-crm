...
"</div>" +
	...
	if (creditLimit == ""){
		...
		div.innerHTML += "<span id=\"" + divId + "-spanLimit\">Limit</span>: <input id=\"" + divId + "-iptCredit\" name=\"" + divId + "-iptCredit\" type=\"text\" value=\"\" size=\"9\" maxlength=\"7\" onKeyUp=\"filedFilter(document.getElementById('" + divId + "-iptCredit'),'numeric');calculateBalance('" + divId + "');\" >";
	}else{
		...
		div.innerHTML += "<span id=\"" + divId + "-spanLimit\">Limit</span>: <input id=\"" + divId + "-iptCredit\" name=\"" + divId + "-iptCredit\" type=\"text\" value=\"" + creditLimit + "\" size=\"9\" maxlength=\"7\" readonly>";
	}
	divContainer.appendChild(div);
