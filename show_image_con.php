...
$fields = mysql_list_fields("asterisk", "contact", $link);
...
//**************************************
$show_msg .= "</ul></td>";
$show_msg .= "<td style='border:0;' valign='top'><div style='width:700px;height:auto;margin:0;overflow: scroll;border:1px double #cccccc'><table cellspacing='1' cellpadding='0' border='0' width='100%'>";
