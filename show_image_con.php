...
$show_msg .= "<form action='./insert_con.php' method='post' name='submitForm'><input type='hidden' name='CHECK' value='1'/><table class='imagetable' style=''><tr>";
$show_msg .= "<td style='border:0;width:15%;height:270px;' align='left' valign='top'><ul style='width:100%;height:20px;line-height:20px;list-style:none;text-align:left;'><li height='20px'>1: contact</li><li height='20px'>2: gender</li><li height='20px'>3: position</li><li height='20px'>4: phone</li><li height='20px'>5: ext</li><li height='20px'>6: phone1</li><li height='20px'>7: ext1</li><li height='20px'>8: phone2</li><li height='20px'>9: ext2</li><li height='20px'>10: mobile</li><li height='20px'>11: fax</li><li height='20px'>12: email</li></ul></td>";
