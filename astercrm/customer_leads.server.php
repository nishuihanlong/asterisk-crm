...
//	$attribsHeader[] = 'width="5%"';
	...
	$table->addRowSearchMore("customer_leads",$fieldsFromSearch,$fieldsFromSearchShowAs,$filter,$content,$start,$limit,0,1,$typeFromSearch,$typeFromSearchShowAs,$stype);
