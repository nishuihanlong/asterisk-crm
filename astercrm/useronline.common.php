<?php
/*******************************************************************************
* useronline.common.php
* useronline参数信息文件
* useronline parameter file
...
if ($_SESSION['curuser']['usertype'] != 'admin' && $_SESSION['curuser']['usertype'] != 'groupadmin' && !is_array($_SESSION['curuser']['privileges']['useronline'])) 
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'useronline');

$xajax = new xajax("useronline.server.php");
