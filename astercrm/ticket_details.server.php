...
function createGrid($start = 0, $limit = 1, $filter = null, $content = null, $order = null, $divName = "grid", $ordering = "",$stype=array()){
	...
	$table->addRowSearchMore("ticket_details",$fieldsFromSearch,$fieldsFromSearchShowAs,$filter,$content,$start,$limit,1,1,$typeFromSearch,$typeFromSearchShowAs,$stype);
	...
	// Change here by the name of fields of its database table
		...
		$rowc[] = $row['memo'];
		$rowc[] = $row['creby'];
		$table->addRow("ticket_details",$rowc,1,1,0,$divName,$fields);
 	}
