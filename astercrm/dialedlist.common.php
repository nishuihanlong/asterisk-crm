<?php
/*******************************************************************************
* dialedlist.common.php
* dialedlist
* dialedlist parameter file
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'dialedlist');

$xajax = new xajax("dialedlist.server.php");
...
$xajax->registerFunction("getReport");
