...
<div class="top_banner">
	<ul>
		...
		<a href="trunkinfo.php">'.$locate_common->Translate("Trunkinfo").'</a>&nbsp;&nbsp;&nbsp;<a href="cdr.php">'.$locate_common->Translate("CDR").'</a>&nbsp;&nbsp;&nbsp;<a href="monitorrecords.php">'.$locate_common->Translate("MonitorRecords").'</a>&nbsp;&nbsp;&nbsp;<a href="speeddial.php">'.$locate_common->Translate("SpeedDial").'</a>&nbsp;&nbsp;&nbsp;<a href="report.php">'.$locate_common->Translate("Report").'</a>&nbsp;&nbsp;&nbsp;<a href="campaignresult.php">'.$locate_common->Translate("Campaign Result").'</a>
	</ul>
</div>
				';
		return $html;
