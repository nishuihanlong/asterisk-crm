...
class Common{
	...
	function generateCopyright($skin){
		...
		$html .='
				<div class="end">
				<ul>
				<li>2007-2010 asterCRM - asterCRM home</li>
				<li>version: 0.062 in asterCC 0.14 beta rc1</li>
				</ul>
				</div>
				';
		return $html;
...
<div class="top_banner">
	<ul>
		...
		<a href="trunkinfo.php">'.$locate_common->Translate("Trunkinfo").'</a>&nbsp;&nbsp;&nbsp;<a href="cdr.php">'.$locate_common->Translate("CDR").'</a>&nbsp;&nbsp;&nbsp;<a href="monitorrecords.php">'.$locate_common->Translate("MonitorRecords").'</a>&nbsp;&nbsp;&nbsp;<a href="speeddial.php">'.$locate_common->Translate("SpeedDial").'</a>&nbsp;&nbsp;&nbsp;<a href="report.php">'.$locate_common->Translate("Report").'</a>&nbsp;&nbsp;&nbsp;<a href="campaignresult.php">'.$locate_common->Translate("Campaign Result").'</a>&nbsp;&nbsp;&nbsp;<a href="queuestatus.php">'.$locate_common->Translate("Queue Status").'</a>&nbsp;&nbsp;&nbsp;<a href="agent.php">'.$locate_common->Translate("Agent Settings").'</a>&nbsp;&nbsp;&nbsp;<a href="knowledge.php">'.$locate_common->Translate("knowledge").'</a>&nbsp;&nbsp;&nbsp;<a href="dnc.php">'.$locate_common->Translate("DNC list").'</a>
	</ul>
</div>
				';
		return $html;
