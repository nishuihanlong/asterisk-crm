<?php
/*******************************************************************************
* speeddial.common.php
* speeddial
* speeddial parameter file
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'speeddial');

$xajax = new xajax("speeddial.server.php");
