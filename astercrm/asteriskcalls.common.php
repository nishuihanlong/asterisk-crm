<?php
/*******************************************************************************
* asteriskcalls.common.php
* asteriskcallst参数信息文件

* asteriskcalls parameter file
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'asteriskcalls');

$xajax = new xajax("asteriskcalls.server.php");
