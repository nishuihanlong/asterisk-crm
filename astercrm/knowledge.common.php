<?php
/*******************************************************************************
* knowledge.common.php
* knowledge参数信息文件

* knowledge parameter file
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'knowledge');

$xajax = new xajax("knowledge.server.php");
