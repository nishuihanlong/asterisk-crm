<?php
/*******************************************************************************
* worktimepackages.common.php
* worktimepackages参数信息文件

* worktimepackages parameter file
...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'worktimepackages');

$xajax = new xajax("worktimepackages.server.php");
